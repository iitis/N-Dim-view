...
class DPVISION_DLL_API ConcretePlugin : public QObject, public PluginInterface
{
	...
	void K3AddMyCloud(std::shared_ptr<SwarmOfAvatars3D> K3MyModel, Eigen::MatrixXd K3ObsCloud, Eigen::MatrixXd K3ViewMat, double K3Toler);
	int K3FormProjectionMatrix(const Eigen::MatrixXd& RawData);
	void K3AddMyCloud2(std::shared_ptr<CModel3D> K3MyModel, Eigen::MatrixXd K3ObsCloud, Eigen::MatrixXd K3ViewMat, double K3Toler);
